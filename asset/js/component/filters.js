const filter = {
  ...
  setupListeners: function () {
    ...
    for (let index = 0; index < inputElt.length; index++) {
      inputElt[index].addEventListener("click", filter.handleInputElt);
    };
  },
  //*-------------------------
  ...
  handleInputElt: function(evt) {
    ...
    for (let index = 0; index < closeElt.length; index++) {
      closeElt[index].addEventListener("click", filter.handleCloseElt);
    }
    //*-------------------------
